...
class Net_aic_transformer_fc(nn.Module):
    ...
    def __init__(self, fine_tune_transformer = False, hparams = {}, loss_fn = None, load_transformer_config = False):
        ...
        self.fc1 = nn.Linear(transformer_out_dim, transformer_out_dim // 2)
        self.ln1 = nn.LayerNorm(transformer_out_dim // 2)
        self.relu = nn.ReLU()

        self.classifier = nn.Linear(transformer_out_dim // 2, self.n_labels)
...
class ArgIdenClassModel():
    ...
    def __init__(
        ...
        self.model = Net_aic_transformer_fc( 
