...
class Trainer_aic_transformer_simple(Trainer_aic):
    ...
    def compute_forward(self, model, sample, device, optimizer = None):
        ...
        predicate_position = sample['predicate_position_formatted'].to(device)

        # outputs:
        labels = sample['roles_formatted']
        ...
        return {
            ...
            'predicate_position': sample['predicate_position'],
            'predicate_position_formatted': predicate_position,
        }
