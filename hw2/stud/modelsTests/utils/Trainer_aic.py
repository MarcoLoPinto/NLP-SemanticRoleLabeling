...
class Trainer_aic(Trainer):
    ...
    def compute_evaluations(self, labels, predictions):
        ...
        evaluations_results['arg_iden'] = Trainer_aic.evaluate_argument_identification(labels, predictions, null_tag)
        evaluations_results['arg_class'] = Trainer_aic.evaluate_argument_classification(labels, predictions, null_tag)
